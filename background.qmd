...
flowchart TD
    ...
    Transport1["William Stewart<br/>Investment, Climate Change,<br/>& Planning - Director"]
    ...
    Programmes1["Richard Whiteley<br/>Transport Programmes<br>- Manager"]:::yellow 

    Data1["Jonathon Clifton<br/>Strategy, Performance,<br/>& Communications - Director"]
    Data2["James Ford<br/>Chief Data Officer"]
    Data3["Nicola Mchugh<br/>Corporate Performance<br/>& Insight - Manager"]:::yellow
...
![Summary of Interventions & Policies](resources/road-safety-interventions.png){#fig-interventions .lightbox width=80% fig-align="left"}
...
```{mermaid}
%%| label: fig-as-is-spots
%%| fig-cap: "As-is (spots) decision process"
%%| echo: true
%%| code-fold: hide
...
```{mermaid}
%%| label: fig-as-is-lengths
%%| fig-cap: "As-is (lengths) decision process"
%%| echo: true
%%| code-fold: hide
